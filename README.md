> [!NOTE] Rama de desarrollo para el LXC de llamaswap con backend ROCm.

Aquí sólo estarán las configuraciones y modelos que se haya comprobado que funcionan de manera estable y mejor que en Vulkan.

## Comandos

- `nix flake show .` - Muestra información sobre la flake.
- `sudo nixos-rebuild switch --flake .#nixos-llamaswap-rocm`.
